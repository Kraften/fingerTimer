...
public class Timer extends View {
    ...
    private static final int DEFAULT_PASS_COLOR = Color.parseColor("#3349d6");
    private static final int DEFAULT_PASS_WIDTH = 2;
    private static final int DEFAULT_REMAIN_COLOR_1 = Color.parseColor("#3349d6");
    private static final int DEFAULT_REMAIN_COLOR_2 = Color.parseColor("#9AFF9A");
    private static final int DEFAULT_REMAIN_COLOR_3 = Color.parseColor("#e06057");
...
//        Log.i(TAG, "textPaintSize:" + this.textPaint.getTextSize());
    ...
    private void generateAndSetBackground() {
        if (background == null) {
            background = new GradientDrawable(GradientDrawable.Orientation.TL_BR, new int[]{0xff00ff00, 0xff299E88});
